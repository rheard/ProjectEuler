...
def solve(max_L=10**9):
    ...
    """
    # Note: I solved this problem before finding the coprime tree generation method, which is why I discuss testing for
    #   coprime. However, thanks to the pattern found, we don't need to generate coprime pairs using that method.
    running_sum = 0
